...
(1, 2, '12345', '2021-01-28'),
(3, 2, '12345', '2021-01-28'),
(5, 11, 'okok', '2021-01-28'),
(6, 11, '답글2개?', '2021-01-28');
...
--
ALTER TABLE `gold_ans`
  MODIFY `gold_ans_num` int(11) NOT NULL AUTO_INCREMENT COMMENT '고유번호', AUTO_INCREMENT=7;
COMMIT;
